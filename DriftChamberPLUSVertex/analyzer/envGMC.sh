...
then
	...
	export PRJBASE="/afs/cern.ch/work/g/gtassiel/public/sw/IDEAsl/IDEA/DriftChamberPLUSVertex"
fi
...
then
	...
	export GENFIT2SYS=/afs/cern.ch/work/g/gtassiel/public/sw/GenFit/master20191106/install
